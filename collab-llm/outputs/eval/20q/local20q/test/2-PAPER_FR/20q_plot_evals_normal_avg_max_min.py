...
def process_folder(folder_path):
    ...
    def plot_with_label_stacking(ax, x_vals, y_vals, labels, title, ylabel):
        ...
        full_title = f"{title}\nAvg: {avg:.3f} | Min: {minimum:.3f} | Max: {maximum:.3f}"
    ...
    plt.savefig(os.path.join(folder_path, "plot_normal_all.png"), dpi=300)
    plt.close()

# Walk through all subdirectories and process them
