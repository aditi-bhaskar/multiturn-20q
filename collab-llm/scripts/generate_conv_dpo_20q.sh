...
export START_OBJ_NUM=270           # number of objects/games we start from (useful for running multiple times)
...
#  completed ranges: 40-269 -- temperature = 0.7
#  running range:  270-299 
#  todo range: 300+  
